...
namespace XHS.Build.Admin.Controllers
{
    ...
    public class RoleRightController : ControllerBase
    {
        ...
        /// 
        /// </summary>
        public RoleRightController(IRoleRightService roleRightService, IUser user)
        {
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<IResponseOutput> GetAll(int ROLEID)
        {
            return ResponseOutput.Ok(await _roleRightService.GetAll(ROLEID));
        }
