...
namespace XHS.Build.Common.Helps
{
    ...
    {
        public static T ConvertObject<T>(this string json) where T : new()
        {
        ...
        {
            return isMilliseconds ? DateTimeExtensions.TimestampStart.AddHours(8).AddMilliseconds(timeStamp) :
                DateTimeExtensions.TimestampStart.AddHours(8).AddSeconds(timeStamp);
        }
