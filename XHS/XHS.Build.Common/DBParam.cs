...
namespace XHS.Build.Common
{
    ...
    public class DBParam : Dictionary<string, object>
    {
        ...
        /// <param name="jsonText">json</param>
        /// <returns>结果集</returns>
        public static Dictionary<string, object> json2DicObj(string jsonText)
        {
            Dictionary<string, object> sdList = new Dictionary<string, object>();
            JObject mJObj = JObject.Parse(jsonText);
            sdList = mJObj.ToObject<Dictionary<string, object>>();
            return sdList;
        }
    }
}
