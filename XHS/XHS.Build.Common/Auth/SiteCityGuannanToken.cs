...
{
    public class SiteCityGuannanToken
    {
        private readonly ICache _cache;
        private readonly ILogger<SiteCityGuannanToken> _logger;
        private readonly IConfiguration _configuration;
        private static readonly Mutex mutex = new Mutex();
        private static readonly Mutex mutexcenter = new Mutex();
        public SiteCityGuannanToken(ICache cache, ILogger<SiteCityGuannanToken> logger, IConfiguration configuration)
        {
            _cache = cache;
            _logger = logger;
        ...
        {
            string key = string.Format(CacheKey.CenterNetToken, "GuannanSiteCityToken:"+ account);
            ...
            if (string.IsNullOrEmpty(token))
            {
                try
                {
                    ...
                    string retString = "";                   
                    Url = url + "Security/getToken?appkey=" + account + "&appsecret=" + password;
