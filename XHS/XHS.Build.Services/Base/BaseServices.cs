...
namespace XHS.Build.Services.Base
{
    public class BaseServices<TEntity> : IBaseServices<TEntity> where TEntity : class, new()
    {
        ...
        {
            return await BaseDal.AddEntity(model);
        }
        ...
        public async Task<PageOutput<TEntity>> QueryPage(Expression<Func<TEntity, bool>> whereExpression,
