...
{
    public interface IVideoService:IBaseServices<BaseEntity>
    {
        /// <summary>
        /// 检索视频
        /// <returns>结果集</returns>
        ...
        /// <returns></returns>
        BnCameraResult<BnPlaybackURL> GetRealurl(BnCamera bc);
        ...
        /// <returns></returns>
        BnCameraResult<BnPlaybackURL> GetPlayBackurl(BnCamera bc);
        ...
        /// <returns></returns>
        BnCameraResult<BnPlaybackURL> ptz(BnCamera bc);

        Task<DataTable> GetListAsync(int GROUPID);
    }
}
