...
namespace xhs.build.SmartCity.Controllers
{
    ...
    public class SettingController : ControllerBase
    {
        ...
        public IResponseOutput GetList()
        {
            ...
            try
            {
                if (_hpSystemSetting.getSettingValue(Const.Setting.S182) == "18")
                {
                    result = new JObject{
                    ...
                    { Const.Setting.S097, _hpSystemSetting.getSettingValue(Const.Setting.S160) },
                    { Const.Setting.S098, _hpSystemSetting.getSettingValue(Const.Setting.S161) },
                    { Const.Setting.S099, _hpSystemSetting.getSettingValue(Const.Setting.S162) }
                ...
                else
                {
                    ...
                    //{ Const.Setting.S142, UEncrypter.EncryptByRSA(_hpSystemSetting.getSettingValue(Const.Setting.S142), Const.Encryp.PUBLIC_KEY) },
                    //{ Const.Setting.S143, UEncrypter.EncryptByRSA(_hpSystemSetting.getSettingValue(Const.Setting.S143), Const.Encryp.PUBLIC_KEY) },
                    { Const.Setting.S097, _hpSystemSetting.getSettingValue(Const.Setting.S097) },
                    { Const.Setting.S098, _hpSystemSetting.getSettingValue(Const.Setting.S098) },
                    { Const.Setting.S099, _hpSystemSetting.getSettingValue(Const.Setting.S099) }
                    //{ Const.Setting.S147, UEncrypter.EncryptByRSA(_hpSystemSetting.getSettingValue(Const.Setting.S147), Const.Encryp.PUBLIC_KEY) }
                };
                }
