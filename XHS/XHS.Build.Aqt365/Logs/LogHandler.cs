...
namespace XHS.Build.Aqt365.Logs
{
    public class LogHandler : ILogHandler
    {
        ...
        public async Task LogAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            //请求api响应内容
            var res = actionResult == null || actionResult is EmptyResult ? null : actionResult.Value as IResponseOutput;
            ...
            var LogEntity = new OpenApiOperateLog
            {
            ...
            await _operateLogService.AddOpenApiLog(LogEntity);
