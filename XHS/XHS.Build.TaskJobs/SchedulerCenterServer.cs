...
namespace XHS.Build.TaskJobs
{
    ...
    public class SchedulerCenterServer : ISchedulerCenter
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IResponseOutput<string>> StartScheduleAsync()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IResponseOutput<string>> StopScheduleAsync()
        {
            var result = new ResponseOutput<string>();
            try
            {
        ...
        /// <returns></returns>
        public async Task<IResponseOutput<string>> AddScheduleJobAsync(TasksQz tasksQz)
        {
            var result = new ResponseOutput<string>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IResponseOutput<string>> StopScheduleJobAsync(TasksQz sysSchedule)
        {
            var result = new ResponseOutput<string>();
            try
            {
        ...
        /// <param name="tasksQz"></param>
        /// <returns></returns>
        public async Task<IResponseOutput<string>> ResumeJob(TasksQz tasksQz)
        {
            var result = new ResponseOutput<string>();
            try
            {
