...
{
    public class SiteEmployeeJob : JobBase, IJob
    {
        private readonly ILogger<SiteEmployeeJob> _logger;
        private readonly IDailyJobService _dailyJobService; 
        public SiteEmployeeJob(ILogger<SiteEmployeeJob> logger, IDailyJobService dailyJobService )
        {
            _logger = logger;
