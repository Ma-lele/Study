...
namespace XHS.Build.City.Logs
{
    public class LogHandler : ILogHandler
    {
        ...
        public async Task LogAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
           ...
           // var res = actionResult == null || actionResult is EmptyResult ? null : actionResult.Value;
            ...
            var LogEntity = new CityOpenApiOperateLog
            {
            ...
            await _operateLogService.AddCityOpenApiLog(LogEntity);
